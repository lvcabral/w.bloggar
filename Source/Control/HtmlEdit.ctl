...
Begin VB.UserControl HtmlEdit 
   ...
   ScaleHeight     =   1335
   ScaleWidth      =   2655
   ToolboxBitmap   =   "HtmlEdit.ctx":0000
...
Dim strCode As String, lngPos As Long
   ...
   If Not mProp_Entities Then GoTo RaiseKeyPress
    ...
    Case Asc("™"): strCode = "&trade;"
    Case Asc("¢"): strCode = "&cent;"
    Case Asc("£"): strCode = "&pound;"
    Case Asc("¤"): strCode = "&curren;"
    ...
    Case Asc("”"): strCode = "&#8221;"
    Case Asc("…"): strCode = "&#8230;"
    Case Asc("¿"): strCode = "&iquest;"
    Case Asc("¡"): strCode = "&iexcl;"
    Case Asc("±"): strCode = "&plusmn;"
    Case Asc("¬"): strCode = "&not;"
    Case Asc("†"): strCode = "&dagger;"
    Case Asc("‡"): strCode = "&Dagger;"
    Case Asc("ƒ"): strCode = "&fnof;"
    Case Asc("‰"): strCode = "&permil;"
    Case Asc("Š"): strCode = "&Scaron;"
    Case Asc("š"): strCode = "&scaron;"
    Case Asc("•"): strCode = "&bull;"
    Case Asc("¯"): strCode = "&macr;"
    Case Asc("¸"): strCode = "&cedil;"
    Case Asc("´"): strCode = "&acute;"
    End Select
    If strCode <> "" Then
        KeyAscii = 0
        lngPos = rtfHTML.SelStart
        rtfHTML.SelText = strCode
        Colorize lngPos, lngPos + Len(strCode)
        rtfHTML.SelStart = lngPos + Len(strCode)
