   ...
   Begin SizerOneLibCtl.TabOne tabWizard 
      ...
      Begin SizerOneLibCtl.ElasticOne ElasticOne2 
         ...
         Begin VB.ComboBox cboPing 
            Height          =   315
            ItemData        =   "AccountMoz.frx":000C
            Left            =   3510
            List            =   "AccountMoz.frx":0019
      ...
      Begin SizerOneLibCtl.ElasticOne ElasticOne2 
         ...
         FloodStyle      =   1
         _GridInfo       =   ""
         Begin MOZILLACONTROLLibCtl.MozillaBrowser webSubscribe 
            Height          =   3135
            Left            =   120
            OleObjectBlob   =   "AccountMoz.frx":FF3D
            TabIndex        =   87
            Top             =   1200
            Width           =   7215
         End
...
Private Sub Form_Load()
    ...
    LoadCombos
    webSubscribe.Navigate2 App.Path & "\CMS\CMS.htm"
    'Fill Image Headers
...
Private Sub tabWizard_Switch(OldTab As Integer, NewTab As Integer, Cancel As Integer)
    ...
    If NewTab = TAB_LOGIN Then
        cmdWizard(1).Caption = "Finish"
    Else
        cmdWizard(1).Caption = "Next >"
    End If
...
Dim intNext As Integer, a As Integer
    ...
    For a = 0 To 99
        ...
        If CBool(GetSetting(REGISTRY_KEY, strReg, "Deleted", "0")) Then
            intNext = a
            Exit For
        End If
    Next
